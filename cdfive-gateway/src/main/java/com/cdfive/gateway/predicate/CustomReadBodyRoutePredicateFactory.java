...
public class CustomReadBodyRoutePredicateFactory extends AbstractRoutePredicateFactory<CustomReadBodyRoutePredicateFactory.Config> {
    ...
    public CustomReadBodyRoutePredicateFactory() {
        super(CustomReadBodyRoutePredicateFactory.Config.class);
    }

    @Override
    @SuppressWarnings("unchecked")
    public AsyncPredicate<ServerWebExchange> applyAsync(CustomReadBodyRoutePredicateFactory.Config config) {
        return exchange -> {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public Predicate<ServerWebExchange> apply(CustomReadBodyRoutePredicateFactory.Config config) {
