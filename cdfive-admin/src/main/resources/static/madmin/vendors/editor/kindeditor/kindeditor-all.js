...
function writeConfig(){
	...
	for (var i = 0, len = els.length; i < len; i++) {
		...
		if (/kindeditor[\w\-\.]*\.js/.test(src)) {
			...
			var configPath = basePath+"/config.js";
			var configScript= document.createElement('script'); 
			configScript.charset= 'utf-8'; 
			configScript.src= configPath; 
			var langScript= document.createElement('script'); 
			langScript.charset= 'utf-8'; 
			langScript.src= basePath+"/lang/zh_CN.js";
			var cssRel= document.createElement('link'); 
			cssRel.rel="stylesheet";
			cssRel.href=basePath+"/themes/default/default.css";
			els[i].parentNode.insertBefore(cssRel,els[i]);
			els[i].parentNode.appendChild(langScript);
			els[i].parentNode.appendChild(configScript);
			return;
		}
	}
}
